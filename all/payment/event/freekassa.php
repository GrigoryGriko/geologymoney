...
$merchant_id = '190249';
    ...
    if ( empty($NumRows) ) {
        ...
        if ( !empty($NumRows_2) ) {
            ...
            $db->Query("UPDATE `users_data` SET `".$_REQUEST['us_balance_type']."` = `".$_REQUEST['us_balance_type']."` + '$_REQUEST[AMOUNT]' WHERE `uid` = '$_REQUEST[us_user_id]'");
