...
if ( is_numeric($_GET['g']) or is_string($_GET['g']) ) {
	...
	header('location: /home'); //регистрация реферала
}
                ...
                <div class="element_2_container_5">
                    ...
                    <div class="wrapping_element_1_container_5">
                        ...
                        <div class="sroke_3_element_2_container_5">
							...
							<script type="text/javascript">
							VK.Widgets.Group("vk_groups", {mode: 4, width: "507", height: "182"}, 56605711);
							</script>
...
echo '          
                    <div class="elementtext_1_footer_1">
                        Copyrights ©'.$year.' <a href="https://geologymoney.com/"><b>geologymoney.com</b></a> All rights reserved.
                    </div>
...
function top_auth($title, $style, $name_mine = false, $JavaScript = false) {
...
/*________A______счетчик онлайн_____A_______*/
	...
	if (isset($_SESSION['page'])) {
		if ( stristr($_SESSION['page'], '?', true) == 'mine' ) {	//обрезка до конкретного символа
			...
			$stroke_2_center_panel = '<a class href="/">Главная</a>&nbsp;/&nbsp;<a href="/my_cabinet">Кабинет пользователя</a>&nbsp;/&nbsp;<a href="/my_field">Моё месторождение</a>&nbsp;/&nbsp;<a href="/'.$_SESSION['page'].'"><span class="data_name_mine">'.$name_mine.'</span></a>';
		}
		else {
	...
	<script type="text/javascript">
        ...
        $(document).on("click", ".area_click_right", function() {
                ...
                if (fallout_menu_border_left == "2px") {
                    ...
                    $(".border_left_fm").css("background", "#76B345");
                }


                var fallout_menu_background_color = $(".fallout_menu").css("background-color");

                if (fallout_menu_background_color == "rgb(35, 38, 50)") {
                    $(".fallout_menu").css("background-color", "#24293A");
                }

                else {
                    $(".fallout_menu").css("background-color", "#232632");    
                }
            });
...
/*контейнер ajax-----VVVVVVVVVVVV--игровой баланс---*/
    echo '
                                    <div class="container_balance_game">
                                        '.round($row_users_data['balance_game'], 2).'<span> руб.</span>
                                    </div>';
/*контейнер ajax-----AAAAAAAAAAAA-----*/
    echo'                               
                                </div>
    ...
    echo '</li>
                                    <li><p class="text_text_menu">Моё месторождение</p></li>
                                </ul>
                            </div>
                        </a>
                        <a href="/market">';
    ...
    echo '</li>
                                    <li><!--<p class="text_text_menu">--><p class="text_text_menu_new">Игры на деньги<sup style="color: #ef3434; margin-left: 5px;">+NEW</sup></p></li>
...
function bottom_auth($toogle = 'exist_footer') {
	MessageShow();
	if ($toogle == 'exist_footer') {
	   echo '
                    <footer class="footer">
                    © '.date("Y").' GeologyMoney - All Rights Reserved. 
                    </footer>';
    }
    echo '  
				</div>
