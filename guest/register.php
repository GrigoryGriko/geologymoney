		...
		<div class="general_box">
			<div class="left_side">
				<div class="imgtext_stroke_1_left_side">
					<img src="../img/guest/register/image_background_left_side.png" width="403" height="336">
					...
					<div class="footer_left_side">© '.$year.' <a href="/">GeologyMoney</a> - All right reserved.</div>
				</div>
			</div>
