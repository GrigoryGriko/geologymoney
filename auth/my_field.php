...
?>
<?php
top_auth('Моё месторождение', 'auth/style/my_fieldstyle');
?>
...
function mine_category_in_shop($category) {
	...
	echo '
			...
			">Купить рудник ('.round($assoc_mine_in_shop_WHERE_level_1['price'][$category], 0).' руб.)</button>
				...
				<div class="box_container_e1s3b1cp">
					<div class="container_e1s3b1cp">
						<div class="p_1">
							...
							<p>Месторождение - это специальная территория природного скопления рудников или залежей полезных ископаемых. Ниже отображаются все освоенные вами рудники, не забывайте их посещать и собирать добытые минералы.</p>
						</div>
						<p class="p_2">
							Покупайте минеральные рудники, чтобы увеличить добычу полезных ископаемых, а так же свой заработок. Повышайте уровень рудников, получайте больше добычи, а также дополнительные бонусы (<a href="/leveltab">Таблица уровней</a>).
						</p>
					</div>
				</div>
			</div>
			<div class="element_1_stroke_4_box_1_center_panel">
				<div class="header_e1s4b1cp">
					<div class="drop_down_2">
						...
						Как собирать и продавать добытые минералы
					</div>';
/*echo '
...
echo '
				...
				<div class="box_container_e1s4b1cp">
					<div class="container_e1s4b1cp">
						<div class="p_1">
							...
							<p>Для сбора добытых минералов со всех рудников сразу нажмите кнопку "собрать добычу". Если Вы хотите собрать минералы с конкретного рудника, нажмите "проверить" и соберите минералы уже в разделе выбранного. Для того чтобы продать минералы и получить прибыль Вам необходимо перейти в раздел <a href="/market">Системный рынок</a>.</p>
						</div>
					</div>
				</div>
			</div>
			...
			<img src="../img/auth/my_field/icon_field.png" width="16px" height="16px">
				<p>Рудники на моем месторождении:</p>
			</div>
';
...
//система накопления минералов---AAAA---
	...
	echo '
			<nav class="nav_element_1_stroke_6_box_1_center_panel empty">
				На вашем месторождении нет рудников
			</nav>';
}
