                        ...
                        <tr>
                            <th colspan="6" class="th_1">
                                <div class="image_text_into_td">
                                    ...
                                    Таблица уровней '.$assoc_m_i_s['second_name'][1].'a "'.$assoc_m_i_s['first_name'][1].'"
                                </div>
                            </th>
                        </tr>   
                        <tr id="tr_fill">
    		...
    		<div class="element_1_stroke_3_box_1_center_panel">
                <div class="box_imt_text">
    				...
    				<p class="text_e1s3b1cp">
    					У всех рудников в нашем проекте есть 7 уровней, каждый уровень имеет свою цену и доходность, уровни
                        тщательно сбалансированы между собой, дабы не допустить неравномерное распределение дохода.
    					Повышайте уровень рудников, чтобы получать больше минералов, а также дополнительные бонусы, начиная со 2
