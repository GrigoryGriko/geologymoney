...
?>
<?php
top_auth('Игровой баланс', '/auth/pay/style/payin_gamemoneystyle', false, 'payin_money');
?>
    		...
    		<div class="strokeblock1_cp">
                <div class="container1_sb1cp">
                    <p class="text_container1_sb1cp">
                        Здесь можно пополнить свой собственный игровой баланс. 
                        Игровой баланс необходим для тех, кто играет в игры на деньги, 
                        ознакомиться со списком таких игр вы можете разделе <a href="/games">«Игры»</a>. <b>Если Вы хотели пополнить 
                        свой баланс для покупок перейдите в <a href="/pay/payin_money">соответствующий раздел</a></b>.
                    </p>
                </div>
                <div class="container2_sb1cp">
                    <p>Вывод средств без ограничений</p>
                    <a href="/pay/payout_gamemoney">
                        <button id="container2_sb1cp_button" class="container2_sb1cp_button">
                            <div class="b">Вывести игровые деньги</div>
                        </button>
                    </a>
                </div>
            </div>
...
for ($id3 = 1; $id3 <= $ps_count; $id3++) {
    ...
    echo '
                <form id="'.$form_id3.'" class="form_class" style="display: none" name="'.$name_id3.'" method="post" action="/actions/pay_money">
                    ...
                    <input type="hidden" name="ad_balance" value="-1">
