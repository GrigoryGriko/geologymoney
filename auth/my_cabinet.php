...
?>
<?php
top_auth('Мой кабинет', 'auth/style/my_cabinetstyle', false, 'my_cabinet');
				...
				<div class="diagramma_round_box_2_center_panel">
                    ...
                    <pre id="code" class="prettyprint linenums" style="display: none;"> <!-- Убрать отображение кода, но оставить результат его работы -->
                        Morris.Donut({
                            element: "graph",
                            data: [
                            {value: '.$a.', label: "'.$as_u_s['money_earn_mine'].' руб.", formatted: "Развитие рудников" },
