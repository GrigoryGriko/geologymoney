	...
	if ( is_numeric($_GET['id']) ) {
		...
		if ( !empty($NumRows) ) {
			...
			if ( !empty($NumRows2) ) {
				...
				$name_mine = 'Рудник "'.$assoc_u_a_m['first_name'].'", Уровень '.$assoc_u_a_m['level']; //название рудника с уровнем
...
/*контейнер ajax-----AAAAAAAAAAAA-----*/
		...
		echo '
					...
					<tr>
						<th class="th_1" colspan="4">
                            <div class="image_text_into_td">
                                ...
                                Таблица уровней '.$assoc_u_a_m['second_name'].'a "'.$assoc_u_a_m['first_name'].'"
                            </div>
                        </th>
				    </tr>	
					<tr id="tr_fill">
			...
			<div class="element_1_stroke_6_box_2_center_panel">
