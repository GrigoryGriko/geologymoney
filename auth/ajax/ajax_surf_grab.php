		...
		<div id="container_captcha">	
			<div class="box_captcha_image_12">
				<div class="box_c_i_12">
					...
					<input class="input_captcha" type="number" placeholder="Введите капчу (число от 0 до 5)" id="captcha" onfocus="this.className=\'onfocus\'" onblur="this.className=\'onblur\'">
