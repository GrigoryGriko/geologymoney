			...
			<div class="element_1_stroke_3_box_1_center_panel">
				<div class="container_e1s3b1cp">
					<div class="p_1">
						...
						Минимальное кол-во минералов одного типа для продажи - 1000, курс продажи <b>фиксирован</b>, и не будет
						меняться. Средства вырученные с продажи минералов Вы можете вывести из проекта любым способом, либо обменять
						и купить больше рудников, поднять уровень уже купленных рудников или же потратить на рекламу.</p>
					</div>
				</div>
			</div>
			<div class="element_1_stroke_4_box_1_center_panel">
				<img src="../img/auth/market/icon_market.png" width="16px" height="16px">
				Минералы на вашем складе
			</div>
					...
					<li>
						<div class="element_1234-e1s5b1cp" id="sell_mineral_'.$category.'">
							<div class="stroketext_1-element_1234-e1s5b1cp">
								<p><span>Минералы '.$assoc_mine_in_shop['second_name'][$category].'а</span><br>"'.$assoc_mine_in_shop['first_name'][$category].'"</p>
							</div>
...
/*контейнер ajax-----AAAAAAAAAAAA-----*/
	echo'
							...
							<button class="stroketext_3-element_1234-e1s5b1cp">
								Курс за '.round($assoc_data_mineral_to_sell['for_count'][$category], 0).' минералов<br>
