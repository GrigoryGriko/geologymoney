    			...
    			<div class="stroke_3_box_1_center_panel">
    		        ...
    		        <div class="element_2_stroke_3_box_1_center_panel">
                        <div class="content_e2s3b1cp">
                            <p>
    				           Калькулятор дохода служит для расчета Вашей прибыли от нанятых шахтеров. <b>Калькулятор 
                               ...
                               год согласно доходности каждого из представленных на проекте шахтеров. Для использования
                               калькулятора введите необходимое для расчета количество шахтеров разных уровней в 
                               соответствующие формы, а затем нажмите кнопку в нижней части страницы. По умолчанию в 
                               формах уже введено количество шахтеров которое уже наняты в вашей шахте на данный момент.
    				        </p>
                        </div>
    		        </div>
...
/*--------------------------------------разделение блоков---------------------------------------------------------*/
    ...
    for ($category = 1; $category <= 4; $category++) {  //checkpoint неправильно устанавливается цена минерала
    		        ...
    		        <div class="element_stroke_4_box_1_center_panel">
                        <div class="th_line_es4b1cp">
    		           		<div class="p_th_line_es4b1cp">
    		           			Рудник "'.$assoc_mine['first_name'][$category][1].'"
        ...
        for ($level = 1; $level <= 7; $level++) {
            echo '
                            <p class="text_line_es4b1cp">Рудник '.$level.' уровня:</p>
    ...
    echo '                  		        		        		        
        ...
        <script>
            $(document).ready(function() {
                ...
                calcul();   /*вызываем функцию подсчета сразу, чтобы посчитать прибыль с уже имеющимися рудниками*/
