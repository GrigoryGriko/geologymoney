...
$secret_link = "/schulte_tab_(event)?i=".$hash_link."";
...
if ($_POST['user_id'] == $_SESSION['id'] ) {
    ...
    if ($_POST['sum_bet'] >= 0.01) {
        ...
        MessageSend('Минимальная сумма ставки 0.01 руб.', '/schulte_tab(start)');
    }
}
else {
    MessageSend('Доступ запрещён', '/schulte_tab(start)');
}
