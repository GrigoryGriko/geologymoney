...
?>
<?php
top_auth('Пути добычи', 'auth/games/style/mining_waysstyle(start)');
?>
        	...
        	<div class="centerer_e1s3_center_panel">	
                <div class="element_1_stroke_3_box_1_center_panel">
                    <div class="box_elements_e1s3b1cp">
                        ...
                        <a href="/schulte_tab(event)">Таблица внимательности</a>
                            <form method="post" action="request/mining_waysrequest(start)">
